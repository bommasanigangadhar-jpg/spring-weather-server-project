...
public class WeatherService {
    ...
    public WeatherService() {
        this.restClient = RestClient.builder()
                ...
                .defaultHeader("User-Agent", "WeatherApiClient/1.0 (bommasani.gangadhar@example.com)")
                .build();
    }
    ...
    public String getAlerts(@ToolParam(description = "Two-letter US state code (e.g. CA, NY)") String state) {
        ...
        return alert.features().stream().map(feature -> String.format("""
                                Event: %s
                                Area: %s
                                Severity: %s
                                Description: %s
    ...
    public record Period(@JsonProperty("number") Integer number, @JsonProperty("name") String name,
                         ...
                         @JsonProperty("probabilityOfPrecipitation") Map<String, String> probabilityOfPrecipitation,
